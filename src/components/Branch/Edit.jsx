            ...
            <div>
                  ...
                  >
                        <Form layout="vertical" form={form} onFinish={editBranchFn}>
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl mt-3`}>Filial nomi</p>}
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Filial telefon raqam</p>}
                                    style={{ marginBottom: '10px' }}
                                    name="phone_number"
                              >
                                    <PatternFormat
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Filial kordinatasi</p>}
                                    style={{ marginBottom: '10px' }}
                                    name="location"
                              >
                                    <Input
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Telegram username</p>}
                                    style={{ marginBottom: '10px' }}
                                    name="telegram"
                              >
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Filial ochilish vaqti</p>}
                                    style={{ marginBottom: '10px' }}
                                    name="open_time"
                              >
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Filial yopilish vaqti</p>}
                                    style={{ marginBottom: '10px' }}
                                    name="close_time"
                              >
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Filial logo</p>}
                                    name="logo"
                                    style={{ marginBottom: '10px' }}
                                    className="mb-2"
                              >
                              ...
                              <Form.Item
                                    label={<p className={`${theme ? "text-black" : "text-black"} font-medium text-xl`}>Filial cover uchun rasm</p>}
