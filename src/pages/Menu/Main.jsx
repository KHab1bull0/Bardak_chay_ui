...
export const MainPage = () => {
      ...
      return (
            <div className="pt-1">
                              ...
                              {branches?.length > 0 && branches.map((branch, index) => {
                                    ...
                                    return (
                                          <div key={index} className="min-w-[100%]">
                                                ...
                                                <h2 className="text-xl py-3 font-semibold">{branch.name}</h2>
                                          </div>
                                    )
                              })}
                        </div>
                  ...
                  <div className={`sticky top-0 mt-2 shadow-md px-2 z-[1000] bg-white rounded-xl transition-colors duration-300`}>
                                                      ...
                                                      products
                                                            ...
                                                            .map((p, index) => {
                                                                  ...
                                                                  return (
                                                                        <div
                                                                              key={index}
                                                                              className={`${theme ? 'bg-white' : 'bg-light-gray'} w-[46vw] min-h-[250px] p-2 shadow-md rounded-2xl flex flex-col gap-1`}
                                                                        >
                                                                              ...
                                                                              <div className={`flex ${orderCount ? "justify-between  py-1 px-3" : 'justify-center  py-2 px-3'} items-center bg-white mt-2 rounded-xl`}>
                                                                                    {orderCount > 0 &&
                                                                                          <>
                                                                                                <button
