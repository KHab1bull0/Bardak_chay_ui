...
export const Buyurtma = () => {
      ...
      return (
            <div className={`${theme ? "bg-dark text-black" : "bg-white text-black"} h-[89vh] overflow-y-scroll scrollbar-hide p-4 rounded-xl`}>
                  ...
                  <div className={`${theme ? "border-black" : "border-gray-200"} mt-4 h-[82%] border-2 rounded-xl overflow-hidden `}>
                                    ...
                                    return (
                                          ...
                                          >
                                                ...
                                                <div
                                                      ...
                                                      className={`py-3 px-2 text-base font-medium  w-[20%]`}
                                                >
                                                      <span
                                                            onClick={(e) => {
                                                                  e.stopPropagation()
                  ...
                  <CustomModal
                        ...
                        className={`${theme ? "bg-dark" : "bg-beji"} relative rounded-lg shadow-lg w-[80%] h-[95%] py-6 px-4`}
                        footerPosition={`absolute bottom-10 right-10`}
                        footer={
                              <div className={`flex justify-end relative ${selectedOrder?.status == 'pending' ? "" : "hidden"}`}>
                                    <button
                                          className={`${theme ? "bg-brown text-white" : "bg-white text-black font-semibold"}
                  ...
                  >
                        <div className="mt-10 pb-20 h-[32rem] overflow-y-scroll">
                              ...
                              <div className={`absolute bottom-12 ${selectedOrder?.status == 'pending' ? "left-26" : "right-32"}  text-5xl font-bold font-poppins`}>
